        ...
        <div className="flex items-center gap-7">
          {[
            ...
            <button
              key={item.label}
              onClick={item.fn}
              className="font-sans text-[0.52rem] tracking-[0.2em] text-white/30 hover:text-[#c9a96e]/75 uppercase transition-colors duration-300 cursor-pointer bg-transparent border-none font-medium"
            >
              {item.label}
            </button>
          ))}
